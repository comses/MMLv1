...
#
# MODULE:       r.pngmap
# AUTHOR(S):    sbergin / iullah
# COPYRIGHT:    (C) 2009 GRASS Development Team/iullah, sbergin
#
#  description: quickly outout a png of any vector to a specified location and filename
...
def main():
    ...
    subprocess.Popen('d.vect icon=basic/circle size=10 fcolor=red map=%s' % os.getenv("GIS_OPT_inmap"), shell='bash').wait()
